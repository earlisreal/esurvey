...
function savePageTitle(){
    $('#save-page-title').click(function () {
        ...
        title = $.trim($('#page-title').val());
        description = $.trim($('#page-description').val());
        ...
        $.ajax(createUrl, {
            ...
            success: function (data) {
                ...
                if(title != ""){
                    ...
                    page.find($('.edit-page-title')).html(
                        '<span class="glyphicon glyphicon-plus"></span>Add Page Title'
                    );

                }
                page.find($('.page-description')).html(description);
