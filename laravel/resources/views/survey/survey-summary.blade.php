...
<ul class="nav nav-tabs">
    <li role="presentation" class="active"><a href="{{ url('/analyze/' .$survey->id .'/summary') }}" aria-controls="home" role="tab"><i class="fa fa-pie-chart"></i> Summary</a></li>
    <li role="presentation"><a href="{{ url('/analyze/' .$survey->id .'/user') }}" aria-controls="by-user" role="tab"><i class="fa fa-users"></i> User Responses</a></li>
</ul>
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-6">
                    <div class="pull-right">
                        ...
                        <div class="input-group">
                            <a id="to-pdf" href="{{ url('/analyze/' .$survey->id .'/result.pdf') }}" target="_blank" class="btn btn-danger"><span class="fa fa-file-pdf-o"></span><span> Generate Pdf</span></a>
                        </div>
                    </div>
                </div>
            </div>
