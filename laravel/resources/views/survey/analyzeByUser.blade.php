...
@section('content')
    ...
    <ul class="nav nav-tabs">
        <li role="presentation"><a href="{{ url('/analyze/' .$survey->id .'?tab=summary') }}" aria-controls="home"
                                   role="tab"><i class="fa fa-pie-chart"></i> Summary</a></li>
        <li role="presentation" class="active"><a href="{{ url('/analyze/' .$survey->id .'?tab=user') }}"
                                                  aria-controls="by-user" role="tab"><i class="fa fa-users"></i> User
                Responses</a></li>
    </ul>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <button id="filter-btn" class="btn btn-primary daterange-btn"><span
                                        class="fa fa-filter"></span> <span id="current-filter"> None</span></button>
                        </div>
                    </div>
